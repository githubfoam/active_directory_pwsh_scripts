#ChatGPT
#Here's a PowerShell script that subtracts the maximum password age from the password last set date for all users 
#in Active Directory and prints the results
